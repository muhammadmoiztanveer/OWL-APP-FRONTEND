...
export default function DarkSidebarPage() {
  useEffect(() => {
    // Set dark sidebar attribute on body
    document.body.setAttribute('data-sidebar', 'dark')
    
    return () => {
      // Cleanup: remove the attribute when component unmounts
      document.body.removeAttribute('data-sidebar')
    }
  }, [])

  const topUsers = [
    { name: 'Glenn Holden', location: 'Nevada', status: 'Cancel', statusClass: 'bg-danger-subtle text-danger', amount: '$250.00', trend: 'up' },
    { name: 'Lolita Hamill', location: 'Texas', status: 'Success', statusClass: 'bg-success-subtle text-success', amount: '$110.00', trend: 'down' },
    { name: 'Robert Mercer', location: 'California', status: 'Active', statusClass: 'bg-info-subtle text-info', amount: '$420.00', trend: 'up' },
    { name: 'Marie Kim', location: 'Montana', status: 'Pending', statusClass: 'bg-warning-subtle text-warning', amount: '$120.00', trend: 'down' },
    { name: 'Sonya Henshaw', location: 'Colorado', status: 'Active', statusClass: 'bg-info-subtle text-info', amount: '$112.00', trend: 'up' },
    { name: 'Marie Kim', location: 'Australia', status: 'Success', statusClass: 'bg-success-subtle text-success', amount: '$120.00', trend: 'down' },
    { name: 'Sonya Henshaw', location: 'India', status: 'Cancel', statusClass: 'bg-danger-subtle text-danger', amount: '$112.00', trend: 'up' },
  ]

  const transactions = [
    { id: '#MB2540', name: 'Neal Matthews', date: '07 Oct, 2019', total: '$400', status: 'Paid', statusClass: 'bg-success-subtle text-success', method: 'Mastercard', icon: 'fab fa-cc-mastercard' },
    { id: '#MB2541', name: 'Jamal Burnett', date: '07 Oct, 2019', total: '$380', status: 'Chargeback', statusClass: 'bg-danger-subtle text-danger', method: 'Visa', icon: 'fab fa-cc-visa' },
    { id: '#MB2542', name: 'Juan Mitchell', date: '06 Oct, 2019', total: '$384', status: 'Paid', statusClass: 'bg-success-subtle text-success', method: 'Paypal', icon: 'fab fa-cc-paypal' },
    { id: '#MB2543', name: 'Barry Dick', date: '05 Oct, 2019', total: '$412', status: 'Paid', statusClass: 'bg-success-subtle text-success', method: 'Mastercard', icon: 'fab fa-cc-mastercard' },
    { id: '#MB2544', name: 'Ronald Taylor', date: '04 Oct, 2019', total: '$404', status: 'Refund', statusClass: 'bg-warning-subtle text-warning', method: 'Visa', icon: 'fab fa-cc-visa' },
    { id: '#MB2545', name: 'Jacob Hunter', date: '04 Oct, 2019', total: '$392', status: 'Paid', statusClass: 'bg-success-subtle text-success', method: 'Paypal', icon: 'fab fa-cc-paypal' },
  ]

  return (
    <>
      <Breadcrumb pagetitle="Vertical" title="Dark Sidebar" />
                    ...
                    <tbody>
                      {topUsers.map((user, index) => (
                        <tr key={index}>
                          <td style={{ width: '20px' }}>
                            <Image
                              src={`/assets/images/users/avatar-${index + 4}.jpg`}
                          ...
                          <td>
                            <span className={`badge ${user.statusClass} font-size-12`}>{user.status}</span>
                          </td>
                          <td className="text-muted fw-semibold text-end">
                            <i className={`icon-xs icon me-2 text-${user.trend === 'up' ? 'success' : 'danger'}`} data-feather="trending-up"></i>
                            {user.amount}
                          </td>
                        </tr>
                      ))}
                  ...
                  <tbody>
                    {transactions.map((transaction, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <span className={`badge rounded-pill ${transaction.statusClass} font-size-12`}>
                            {transaction.status}
                          </span>
                        </td>
                        <td>
                          <i className={`${transaction.icon} me-1`}></i> {transaction.method}
                        </td>
                        <td>
                          <button
                            type="button"
